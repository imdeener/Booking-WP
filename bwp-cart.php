                    ...
                    <div class="booking-item">
                        ...
                        <div class="booking-details">
                            <div class="product-title">
                                <h3 class="booking-title"><a
                                        href="<?php echo esc_url($product->get_permalink()); ?>"><?php echo get_the_title($product_id); ?></a>
                                </h3>
                            </div>
                                ...
                                <div class="guests">
                                    ...
                                    <div class="guest-type adults">
                                        ...
                                        <div class="quantity-controls">
                                            <button type="button" class="quantity-btn minus" data-type="adults"
                                                data-item-key="<?php echo esc_attr($cart_item_key); ?>"
                                                data-min="1">&minus;</button>
                                            <span class="quantity"><?php echo $adults; ?></span>
                                            <button type="button" class="quantity-btn plus" data-type="adults"
                                                data-item-key="<?php echo esc_attr($cart_item_key); ?>"
                                                data-max="<?php echo esc_attr($max_adults); ?>">&plus;</button>
                                        </div>
                                    </div>
                                    <?php
                                    // Get child tiers
                                    ...
                                    <div class="guest-type children">
                                        ...
                                        <div class="quantity-controls">
                                            <button type="button" class="quantity-btn minus" data-type="children"
                                                data-item-key="<?php echo esc_attr($cart_item_key); ?>"
                                                data-min="0">&minus;</button>
                                            <span class="quantity"><?php echo $children; ?></span>
                                            <button type="button" class="quantity-btn plus" data-type="children"
                                                data-item-key="<?php echo esc_attr($cart_item_key); ?>"
                                                data-max="<?php echo esc_attr($max_children); ?>">&plus;</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
?>
    ...
    <div class="bwp-customer-information card--cart">
        <div class="section-header">
            ...
            <?php if (!is_user_logged_in()): ?>
                <a href="<?php echo esc_url(wc_get_page_permalink('myaccount')); ?>"
                    class="btn btn--primary btn--xs btn--quaternary">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <form class="bwp-customer-form">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="first_name" name="first_name"
                        value="<?php echo esc_attr($billing_first_name); ?>" pattern="[A-Za-z ]{2,}"
                        title="Please enter at least 2 letters. Numbers and special characters are not allowed."
                        placeholder="Enter your first name" required>
                </div>
                <div class="form-group">
                    <label for="last_name"><svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_2039_36846)">
                                <path
                                    d="M13.9993 14.0003C16.5777 14.0003 18.666 11.912 18.666 9.33366C18.666 6.75533 16.5777 4.66699 13.9993 4.66699C11.421 4.66699 9.33268 6.75533 9.33268 9.33366C9.33268 11.912 11.421 14.0003 13.9993 14.0003ZM13.9993 16.3337C10.8843 16.3337 4.66602 17.897 4.66602 21.0003V22.167C4.66602 22.8087 5.19102 23.3337 5.83268 23.3337H22.166C22.8077 23.3337 23.3327 22.8087 23.3327 22.167V21.0003C23.3327 17.897 17.1143 16.3337 13.9993 16.3337Z"
                    ...
                    <input type="text" id="last_name" name="last_name" value="<?php echo esc_attr($billing_last_name); ?>"
                        pattern="[A-Za-z ]{2,}"
                        title="Please enter at least 2 letters. Numbers and special characters are not allowed."
            ...
            <div class="form-group">
                <label for="thai_id"><svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_2039_36853)">
                            <path
                                d="M22.1667 3.5H5.83333C4.55 3.5 3.5 4.55 3.5 5.83333V22.1667C3.5 23.45 4.55 24.5 5.83333 24.5H22.1667C23.45 24.5 24.5 23.45 24.5 22.1667V5.83333C24.5 4.55 23.45 3.5 22.1667 3.5ZM14 7C16.2517 7 18.0833 8.83167 18.0833 11.0833C18.0833 13.335 16.2517 15.1667 14 15.1667C11.7483 15.1667 9.91667 13.335 9.91667 11.0833C9.91667 8.83167 11.7483 7 14 7ZM22.1667 22.1667H5.83333V21.8983C5.83333 21.175 6.16 20.4983 6.72 20.055C8.715 18.4567 11.2467 17.5 14 17.5C16.7533 17.5 19.285 18.4567 21.28 20.055C21.84 20.4983 22.1667 21.1867 22.1667 21.8983V22.1667Z"
                                fill="currentColor" />
                        </g>
                        <defs>
                ...
                <input type="text" id="thai_id" name="thai_id" value="<?php echo esc_attr($billing_thai_id); ?>"
                    pattern="[0-9A-Za-z]{8,}"
                    title="Please enter a valid Thai ID (13 digits) or Passport number (at least 8 characters)"
                    placeholder="Enter Thai ID or Passport number" required>
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label for="email"><svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_2039_36864)">
                                <path
                                    d="M23.334 4.66699H4.66732C3.38398 4.66699 2.34565 5.71699 2.34565 7.00033L2.33398 21.0003C2.33398 22.2837 3.38398 23.3337 4.66732 23.3337H23.334C24.6173 23.3337 25.6673 22.2837 25.6673 21.0003V7.00033C25.6673 5.71699 24.6173 4.66699 23.334 4.66699ZM22.8673 9.62533L14.619 14.782C14.2457 15.0153 13.7557 15.0153 13.3823 14.782L5.13398 9.62533C4.84232 9.43866 4.66732 9.12366 4.66732 8.78533C4.66732 8.00366 5.51898 7.53699 6.18398 7.94533L14.0007 12.8337L21.8173 7.94533C22.4823 7.53699 23.334 8.00366 23.334 8.78533C23.334 9.12366 23.159 9.43866 22.8673 9.62533Z"
                                    fill="currentColor" />
                            </g>
                            <defs>
                    ...
                    <input type="email" id="email" name="email" value="<?php echo esc_attr($billing_email); ?>"
                        pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}" title="Please enter a valid email address"
                        placeholder="Enter your email address" required>
                </div>

                <div class="form-group">
                    <label for="phone"><svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_2039_36872)">
                                <path
                                    d="M22.4355 17.8034L19.4722 17.4651C18.7605 17.3834 18.0605 17.6284 17.5589 18.1301L15.4122 20.2767C12.1105 18.5967 9.40387 15.9017 7.72387 12.5884L9.8822 10.4301C10.3839 9.92839 10.6289 9.22839 10.5472 8.51672L10.2089 5.57672C10.0689 4.39839 9.0772 3.51172 7.8872 3.51172H5.86887C4.55054 3.51172 3.45387 4.60839 3.53554 5.92672C4.15387 15.8901 12.1222 23.8467 22.0739 24.4651C23.3922 24.5467 24.4889 23.4501 24.4889 22.1317V20.1134C24.5005 18.9351 23.6139 17.9434 22.4355 17.8034Z"
                                    fill="currentColor" />
                            </g>
                            <defs>
                    ...
                    <input type="tel" id="phone" name="phone" value="<?php echo esc_attr($billing_phone); ?>"
                        pattern="[0-9+]{9,}"
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="hotel_name">
                        <svg width="24" height="28" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_2116_2421)">
                                <path
                                    d="M7 15.1663C8.66 15.1663 10 13.603 10 11.6663C10 9.72967 8.66 8.16634 7 8.16634C5.34 8.16634 4 9.72967 4 11.6663C4 13.603 5.34 15.1663 7 15.1663ZM19 8.16634H11V16.333H3V5.83301H1V23.333H3V19.833H21V23.333H23V12.833C23 10.2547 21.21 8.16634 19 8.16634Z"
                                    fill="currentColor" />
                            </g>
                            <defs>
                    ...
                    <input type="text" id="hotel_name" name="hotel_name"
                        value="<?php echo esc_attr($billing_hotel_name); ?>" pattern=".{3,}"
                        title="Please enter hotel name (at least 3 characters)" placeholder="Enter hotel name" required>
                </div>
                <div class="form-group">
                    <label for="room">
                        <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M16.8333 7V24.5H4V22.1667H6.33333V3.5H16.8333V4.66667H22.6667V22.1667H25V24.5H20.3333V7H16.8333ZM12.1667 12.8333V15.1667H14.5V12.8333H12.1667Z"
                                fill="currentColor" />
                        </svg>
                        Room *</label>
                    <input type="text" id="room" name="room" value="<?php echo esc_attr($billing_room); ?>"
                        pattern="[A-Za-z0-9 \-]+"
        ...
        <div class="privacy-modal-content">
            ...
            <div class="privacy-modal-footer">
                <div class="privacy-checkbox">
                    ...
                    <label for="accept-privacy">I have read and agree to the Terms of Use and Conditions and Privacy
                        Policy.</label>
                </div>
                ...
                <div class="summary-item">
                        ...
                        <div class="booking-meta">
                            <?php if (isset($cart_item['bwp_start_date'])): ?>
                                <div class="date">
                                    ...
                                    <?php echo esc_html($cart_item['bwp_start_date']); ?>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="guests" data-item-key="<?php echo esc_attr($cart_item_key); ?>">
                                <div class="guest-type adults">
                                    ...
                                    <span class="guest-count" data-item-key="<?php echo esc_attr($cart_item_key); ?>"
                                        data-type="adults"><?php echo isset($cart_item['bwp_adults']) ? $cart_item['bwp_adults'] : 0; ?></span>
                                </div>
                                <?php if (isset($cart_item['bwp_children']) && intval($cart_item['bwp_children']) > 0): ?>
                                    <div class="guest-type children">
                                        ...
                                        <span class="guest-count" data-item-key="<?php echo esc_attr($cart_item_key); ?>"
                                            data-type="children"><?php echo $cart_item['bwp_children']; ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="item-price">
                        <div class="price-breakdown">
                            ...
                            ?>
                            <div class="total-price" data-item-key="<?php echo esc_attr($cart_item_key); ?>">
                                <?php echo wc_price($total_price); ?></div>
                        </div>
                    </div>
                </div>
        <?php
                        ...
                        ?>
                            <div class="coupon-badge">
                                ...
                                <button type="button" class="remove-coupon"
                                    data-coupon="<?php echo esc_attr($coupon_code); ?>">&times;</button>
                            </div>
                        <?php endif; ?>
                    </div>
...
{
    wp_localize_script('jquery', 'bwp_ajax', array(
